...
export const RACES: Race[] = [
  ...
  { round: 6,  name: "Miami GP",               circuit: "Miami International Autodrome",      country: "USA",          date: "2026-05-03", racetimePST: "1:00 PM",  completed: true,  sprint: true,  laps: 57, circuitLengthKm: 5.412, previousWinner: "Lando Norris",      previousWinnerCountry: "UK",          lapRecordHolder: "Max Verstappen",   lapRecordTime: "1:29.708" },
  { round: 7,  name: "Canadian GP",            circuit: "Circuit Gilles Villeneuve",          country: "Canada",       date: "2026-05-24", racetimePST: "1:00 PM",  completed: true, sprint: true,  laps: 70, circuitLengthKm: 4.361, previousWinner: "Max Verstappen",    previousWinnerCountry: "Netherlands", lapRecordHolder: "Valtteri Bottas",  lapRecordTime: "1:13.078" },
