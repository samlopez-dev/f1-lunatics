...
const COUNTRY_CODES: Record<string, string> = {
  ...
  "Colombia":     "co", "Pirate":       "pirate", "Philippines":  "ph",
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        {activeTab === "standings" && (
          <div className="space-y-6 animate-in fade-in">
            {lastRace?.provisional && (
              <div className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-blue-600 text-white text-xs font-bold shadow-md w-fit">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
                </svg>
                Provisional Points · {lastRace.name}
              </div>
            )}
